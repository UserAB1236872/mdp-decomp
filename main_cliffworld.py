...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', default='CliffworldDeterministic-v0', help='Name of the environment')
    ...
    if args.test:
        for suffix in ['_best', '_last']:
            result = monitor.eval(env_fn(), solvers_fn, args.eval_episodes, args.episode_max_steps, render=True,
