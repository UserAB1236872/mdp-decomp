...
python main_cliffworld.py --total_episodes 500 --train_interval 25 --eval_episodes 5 --env CliffworldDeterministic-v0 --no_cuda --train --use_planner --runs 1 --lr 0.01
...
#python main_cliffworld.py --total_episodes 500 --train_interval 25 --eval_episodes 5 --env Cliffworld-v0 --no_cuda --train --use_planner --runs 1
